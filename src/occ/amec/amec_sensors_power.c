...
void amec_update_apss_sensors(void)
{
    ...
    if (G_slv_inbox_received)
    {
        ...
        if (FSP_SUPPORTED_OCC != G_occ_interrupt_type)
        {
            ...
            amec_update_channel_sensor(G_sysConfigData.apss_adc_map.vdd0[l_proc]);
            amec_update_channel_sensor(G_sysConfigData.apss_adc_map.vdd1[l_proc]);
            amec_update_channel_sensor(G_sysConfigData.apss_adc_map.vdd2[l_proc]);
