...
occSysConfigData_t G_sysConfigData =
{
    ...
    .apss_adc_map =   {
        ...
        .vdd0[0]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd0[1]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd0[2]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd0[3]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd1[0]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd1[1]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd1[2]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd1[3]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd2[0]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd2[1]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd2[2]             = SYSCFG_INVALID_ADC_CHAN,
        .vdd2[3]             = SYSCFG_INVALID_ADC_CHAN,
